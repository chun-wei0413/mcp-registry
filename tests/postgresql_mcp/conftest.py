...
from src.postgresql_mcp.infrastructure.database.connection_pool import PostgreSQLConnectionPool
...
async def mock_connection_manager(mock_security_config):
    ...
    manager = PostgreSQLConnectionPool()
    ...
    manager._pools["test_connection"] = mock_pool
